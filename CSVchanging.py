...
column_names = ["Country", "warning level", "recommendation", "the threatened area", "detail", "recommendations"]
...
with open(input_file_path, 'r', encoding='utf-8') as input_file:
    ...
    for row in csv_reader:
        current_country_data.append(row)
        ...
        if len(current_country_data) == 6:
            ...
            transformed_data.append(dict(zip(column_names, [item for sublist in current_country_data for item in sublist])))
            current_country_data = []
